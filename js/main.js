...
const words = ["Exponential", "Innovator", "Data-centric", "Pioneering"];
const typingElement = document.getElementById("typing");
let wordIndex = 0;
let charIndex = 0;
let isDeleting = false;
let typingSpeed = 150;
let displayDelay = 2000;  // Time to display the word before deleting
let isWaiting = false;
...
function type() {
    ...
    if (!isDeleting && charIndex === currentWord.length && !isWaiting) {
        ...
        typingSpeed = displayDelay;  // Pause during display
    } else {
